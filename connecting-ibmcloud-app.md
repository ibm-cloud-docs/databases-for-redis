...
{: #ibmcloud-app-connect-cloud-foundry}
...
The sample app in the [Getting Started](/docs/databases-for-redis?topic=databases-for-redis-getting-started) tutorial provides a sample Cloud Foundry application that uses Node.js and demonstrates how to bind the sample application to a {{site.data.keyword.databases-for-redis}} deployment.
{: .tip}

### Creating a Cloud Foundry alias
{: #ibmcloud-app-create-cloud-foundry-alias}
...
{: #ibmcloud-app-creating-manifest}
...
{: #ibmcloud-app-configuring-cloud-foundry}
