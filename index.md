...
General information on getting connection strings can be found on the [Getting Connection Strings](./using-connection-strings) page.
...
{{site.data.keyword.databases-for-redis}} offers other cloud services integrations. 
